...
rm -rf "$SKILLS_DIR/cf-waf-converter" "$SKILLS_DIR/cf-functions-converter" "$SKILLS_DIR/cf-cdn-analyzer" "$SKILLS_DIR/cf-cdn-analyzer-validator" "$SKILLS_DIR/SKILL.md"

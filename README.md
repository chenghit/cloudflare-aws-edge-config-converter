...
├── account/
│   └── 2026-01-31 10-00-00/
│       ├── IP-Lists.txt                    # Fixed filename
│       ├── List-Items-ip-block-list.txt    # Predictable pattern
│       └── Bulk-Redirect-Rules.txt         # Fixed filename
└── example.com/
    └── 2026-01-31 10-00-00/
        ├── WAF-Custom-Rules.txt            # Fixed filename
        ├── Rate-limits.txt                 # Fixed filename
        └── Redirect-Rules.txt              # Fixed filename
```
...
├── any_name_user_wants.tf      # User-defined name
├── another_name.tf             # User-defined name
└── dns.tf                      # User-defined name
```
